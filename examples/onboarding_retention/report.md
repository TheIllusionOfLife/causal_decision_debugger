...
- **placebo_treatment** — `passed`. Shuffled treatment yields effect -0.0130; main estimate is +0.0644. (Δ vs main: -0.0774)
- **subset_stability** — `passed`. Per-segment estimates: BR: +0.0593, DE: +0.0667, JP: +0.0741, US: +0.0666; max |Δ vs main| = 0.0097 (Δ vs main: +0.0097)
